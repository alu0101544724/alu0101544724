...
const std::string kTitle = "Rotate";
const std::string kHelpText =
  R"( How to use: to use this program you will have to execute it like ./a.out file.txt out_file.txt
    Parameters:
    - file.txt: is the file to read
    -out_file.txt: is the file where the output goes)";
